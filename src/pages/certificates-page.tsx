...
const academic = [
  ...
  { title: "Best Capstone", issuer: "Cagayan State University", year: "2026" },
];

const proficiency = [
  { title: "C# Programming", issuer: "Cagayan State University", year: "2026" },
  {
...
const competitions = [
  { title: "Hack4Gov Participant", issuer: "Hack4Gov", year: "2024" },
  { title: "Hack4Gov Participant", issuer: "Hack4Gov", year: "2025" },
  {
  ...
  { title: "ICT Roadshow 2nd Placer", issuer: "ICT Roadshow", year: "2025" },
];
      ...
      <div className="mx-auto px-6 py-20 space-y-12 max-w-6xl">
        <motion.div {...fadeUp} className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            Awards, certifications, and recognitions that reflect my skills and
            achievements.
          </p>
        </motion.div>
        ...
        <div className="md:p-5 lg:p-7 p-3  border-t">
          <div className="max-w-6xl mx-auto px-6 py-2 flex flex-col-reverse gap-2 md:flex-row items-center md:justify-between">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/Dreisky19" target="_blank">
                <IconBrandFacebookFilled />
              </a>
